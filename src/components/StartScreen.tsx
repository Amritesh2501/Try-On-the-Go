...
const SpotlightCard = ({ children, onClick, className = "" }: { children?: React.ReactNode, onClick: () => void, className?: string }) => {
    ...
    return (
        <div
            className={`group relative border border-gray-200 dark:border-stone-800 bg-white dark:bg-stone-900 overflow-hidden rounded-2xl ${className}`}
          ...
          <AnimatePresence mode="wait">
              ...
              >
                  <div className="w-full max-w-6xl flex flex-col items-center gap-6 py-4 my-auto">
                    ...
                    <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full px-2 md:px-0 flex-1 min-h-0">
                        {/* Option 1: AI Try On */}
                        <SpotlightCard 
                            onClick={() => setMode('try-on')}
                            className="p-5 md:p-8 cursor-pointer md:col-span-2 lg:col-span-1 min-h-[220px]"
                        >
                            <div className="absolute -right-4 -bottom-4 md:top-0 md:right-0 p-3 opacity-5 dark:opacity-[0.03] pointer-events-none">
                                <PlusIcon className="w-40 h-40" />
                            </div>
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-stone-800 flex items-center justify-center mb-6 text-gray-900 dark:text-stone-100 shrink-0">
                                    <CameraIcon className="w-6 h-6" />
                                </div>
                                <div>
                                    <h3 className="text-2xl font-serif text-gray-900 dark:text-stone-50 mb-2">AI Virtual Try-On</h3>
                                    <p className="text-sm text-gray-500 dark:text-stone-400 leading-relaxed max-w-xs">
                                        Create a digital twin and try on unlimited outfits instantly.
                                    </p>
                                </div>
                            </div>
                        </SpotlightCard>
                        ...
                        <SpotlightCard 
                            ...
                            className="p-5 md:p-8 cursor-pointer min-h-[220px]"
                        >
                            <div className="absolute -right-4 -bottom-4 md:top-0 md:right-0 p-3 opacity-5 dark:opacity-[0.03] pointer-events-none">
                            ...
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 dark:text-stone-400 leading-relaxed">
                                        See two outfits side-by-side to choose the perfect one.
                                    </p>
                                </div>
                            </div>
                        </SpotlightCard>
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                ...
                                <div>
                                    <h3 className="text-2xl font-serif text-gray-900 dark:text-stone-50 mb-2">Style Advisor</h3>
                                    <p className="text-sm text-gray-500 dark:text-stone-400 leading-relaxed">
                                        Get instant AI feedback, fit ratings & styling tips.
                                    </p>
                                </div>
                            </div>
                        </SpotlightCard>
